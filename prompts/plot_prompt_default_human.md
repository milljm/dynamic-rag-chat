...
{{gold_documents}}
<END GOLD_DOCUMENTS>
<CHARACTER_SHEET - THE USER PROTAGONIST. USE FOR LORE AND PLOT HOOKS>
{{character_sheet}}
<END CHARACTER_SHEET>
...
<NPC_CHARACTER_SHEETS - JSON BLOCK CONTAINING NAME, GENDER, RACE, APPEARANCE FOR KNOWN CHARACTERS>
{{entities}}
