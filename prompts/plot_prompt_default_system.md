...
<END ANTI_ECHO_RULES>
<WORLD_LORE - PC CHARACTER ({{user_name}}) AND PLOT HOOKS>
{{character_sheet}}
<END WORLD_LORE>
...
<END WRITING_STYLE>
<ADDITIONAL_RULES - ADDITIONAL WRITING_STYLE 'FLAVOR' OR 'FLOURISH' RULES>
{{additional_content}}
...
<END WORLD_RESPONSE>
<NARRATIVE_CONTINUITY - NPC TRACKING RULE>
