...
IMPORTANT: I should use information from the above context, but do not copy their tone or writing style. If they sound repetitive, overly emotional, robotic, sarcastic, or formal—**do not imitate them**.
...
CRITICAL: Always end responses with RAG metadata tags using this format (without alerting the user):
